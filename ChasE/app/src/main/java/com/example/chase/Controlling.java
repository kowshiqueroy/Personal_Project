...
public class Controlling extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOn=(Button)findViewById(R.id.bt1);
        btnOff=(Button)findViewById(R.id.bt2);
        ...
        mDevice = b.getParcelable(BluetoothPage.DEVICE_EXTRA);
        mDeviceUUID = UUID.fromString(b.getString(BluetoothPage.DEVICE_UUID));
        mMaxChars = b.getInt(BluetoothPage.BUFFER_SIZE);
